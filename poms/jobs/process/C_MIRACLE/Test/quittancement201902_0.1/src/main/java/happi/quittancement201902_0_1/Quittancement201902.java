...
package happi.quittancement201902_0_1;
...
/**
 * Job: Quittancement201902 Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Quittancement201902 implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Quittancement201902";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Quittancement201902.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Quittancement201902.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public void tDBConnection_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:NgzrqRXJHo9rt659Dnn8/c78qRxmluJpK2Ym6w==");
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_HAPPI_Quittancement201902 = new byte[0];
    static byte[] commonByteArray_HAPPI_Quittancement201902 = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_HAPPI_Quittancement201902.length) {
				if(length < 1024 && commonByteArray_HAPPI_Quittancement201902.length == 0) {
   					commonByteArray_HAPPI_Quittancement201902 = new byte[1024];
				} else {
   					commonByteArray_HAPPI_Quittancement201902 = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_HAPPI_Quittancement201902, 0, length);
			strReturn = new String(commonByteArray_HAPPI_Quittancement201902, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_HAPPI_Quittancement201902) {
 ...
 */
	...
	row5.DT_MOIS = row1.DT_MOIS;								
	row5.CD_SOCPROP = row1.CD_SOCPROP;								
	row5.NO_DOSFACT = row1.NO_DOSFACT;								
	row5.LB_NATFACT = row1.LB_NATFACT;								
	row5.CD_TYPE_FA = row1.CD_TYPE_FA;								
	row5.SIO_LB_NATLOC = row1.SIO_LB_NATLOC;								
	row5.SID_LB_FAM_RUB = row1.SID_LB_FAM_RUB;								
	row5.NO_RUB_FA = row1.NO_RUB_FA;								
	row5.LB_RUBCOUR = row1.LB_RUBCOUR;								
	row5.TOU_FACT_TOT = row1.TOU_FACT_TOT;			
...
operation_finder_tAggregateRow_4.CD_SOCPROP = row5.CD_SOCPROP;
			operation_finder_tAggregateRow_4.NO_DOSFACT = row5.NO_DOSFACT;
			operation_finder_tAggregateRow_4.LB_NATFACT = row5.LB_NATFACT;
			operation_finder_tAggregateRow_4.CD_TYPE_FA = row5.CD_TYPE_FA;
			operation_finder_tAggregateRow_4.SIO_LB_NATLOC = row5.SIO_LB_NATLOC;
			operation_finder_tAggregateRow_4.SID_LB_FAM_RUB = row5.SID_LB_FAM_RUB;
			operation_finder_tAggregateRow_4.NO_RUB_FA = row5.NO_RUB_FA;
			operation_finder_tAggregateRow_4.LB_RUBCOUR = row5.LB_RUBCOUR;
	...
	if(operation_result_tAggregateRow_4 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_4.CD_SOCPROP = operation_finder_tAggregateRow_4.CD_SOCPROP;
				operation_result_tAggregateRow_4.NO_DOSFACT = operation_finder_tAggregateRow_4.NO_DOSFACT;
				operation_result_tAggregateRow_4.LB_NATFACT = operation_finder_tAggregateRow_4.LB_NATFACT;
				operation_result_tAggregateRow_4.CD_TYPE_FA = operation_finder_tAggregateRow_4.CD_TYPE_FA;
				operation_result_tAggregateRow_4.SIO_LB_NATLOC = operation_finder_tAggregateRow_4.SIO_LB_NATLOC;
				operation_result_tAggregateRow_4.SID_LB_FAM_RUB = operation_finder_tAggregateRow_4.SID_LB_FAM_RUB;
				operation_result_tAggregateRow_4.NO_RUB_FA = operation_finder_tAggregateRow_4.NO_RUB_FA;
				operation_result_tAggregateRow_4.LB_RUBCOUR = operation_finder_tAggregateRow_4.LB_RUBCOUR;
		...
		hash_tAggregateRow_4.put(operation_result_tAggregateRow_4, operation_result_tAggregateRow_4);
					...
					if(operation_result_tAggregateRow_4.TOU_FACT_TOT_sum == null) {
						operation_result_tAggregateRow_4.TOU_FACT_TOT_sum = new BigDecimal(0).setScale(4);
					}
					operation_result_tAggregateRow_4.TOU_FACT_TOT_sum = operation_result_tAggregateRow_4.TOU_FACT_TOT_sum.add(
 ...
 */
	...
	currentComponent="tFileOutputExcel_1";
		...
		String fileName_tFileOutputExcel_1="C:/Users/DKHUON/Desktop/HAPPI/Export/Quittancement 2019 par mois2.xlsx";
 ...
 */
	...
	currentComponent="tFileOutputExcel_3";
		...
		String fileName_tFileOutputExcel_3="C:/Users/DKHUON/Desktop/HAPPI/Export/Quittancement 2019 par DF2.xlsx";
		...
		xlsxTool_tFileOutputExcel_3.addCellValue("DT_MOIS");
		
		xlsxTool_tFileOutputExcel_3.addCellValue("CD_SOCPROP");
		
		xlsxTool_tFileOutputExcel_3.addCellValue("NO_DOSFACT");
		
		xlsxTool_tFileOutputExcel_3.addCellValue("LB_NATFACT");
		
		xlsxTool_tFileOutputExcel_3.addCellValue("CD_TYPE_FA");
		
		xlsxTool_tFileOutputExcel_3.addCellValue("SIO_LB_NATLOC");
		
		xlsxTool_tFileOutputExcel_3.addCellValue("SID_LB_FAM_RUB");
		
		xlsxTool_tFileOutputExcel_3.addCellValue("NO_RUB_FA");
		
		xlsxTool_tFileOutputExcel_3.addCellValue("LB_RUBCOUR");
		
		xlsxTool_tFileOutputExcel_3.addCellValue("TOU_FACT_TOT");
 ...
 */
	...
	currentComponent="tAggregateRow_4_AGGIN";
            				    ...
            				    row7.CD_SOCPROP = aggregated_row_tAggregateRow_4.CD_SOCPROP;
            				    
            				    row7.NO_DOSFACT = aggregated_row_tAggregateRow_4.NO_DOSFACT;
            				    
            				    row7.LB_NATFACT = aggregated_row_tAggregateRow_4.LB_NATFACT;
            				    
            				    row7.CD_TYPE_FA = aggregated_row_tAggregateRow_4.CD_TYPE_FA;
            				    
            				    row7.SIO_LB_NATLOC = aggregated_row_tAggregateRow_4.SIO_LB_NATLOC;
            				    
            				    row7.SID_LB_FAM_RUB = aggregated_row_tAggregateRow_4.SID_LB_FAM_RUB;
            				    
            				    row7.NO_RUB_FA = aggregated_row_tAggregateRow_4.NO_RUB_FA;
            				    
            				    row7.LB_RUBCOUR = aggregated_row_tAggregateRow_4.LB_RUBCOUR;
            				    row7.TOU_FACT_TOT = aggregated_row_tAggregateRow_4.TOU_FACT_TOT_sum;
 ...
 */
	...
	currentComponent="tFileOutputExcel_3";
				...
				xlsxTool_tFileOutputExcel_3.addRow();
	    				...
	    				if(row7.DT_MOIS != null) {
    						
							xlsxTool_tFileOutputExcel_3.addCellValue((row7.DT_MOIS.setScale(0, java.math.RoundingMode.HALF_UP)).doubleValue());
	    				} else {
	    					xlsxTool_tFileOutputExcel_3.addCellNullValue();
	    				}
					
									   				
	    				if(row7.CD_SOCPROP != null) {
    						
							xlsxTool_tFileOutputExcel_3.addCellValue((row7.CD_SOCPROP.setScale(0, java.math.RoundingMode.HALF_UP)).doubleValue());
	    				} else {
	    					xlsxTool_tFileOutputExcel_3.addCellNullValue();
	    				}
					
									   				
	    				if(row7.NO_DOSFACT != null) {
    						
							xlsxTool_tFileOutputExcel_3.addCellValue((row7.NO_DOSFACT.setScale(0, java.math.RoundingMode.HALF_UP)).doubleValue());
	    				} else {
	    					xlsxTool_tFileOutputExcel_3.addCellNullValue();
	    				}
					
									   				
	    				if(row7.LB_NATFACT != null) {
    				
							xlsxTool_tFileOutputExcel_3.addCellValue(String.valueOf(row7.LB_NATFACT));
	    				} else {
	    					xlsxTool_tFileOutputExcel_3.addCellNullValue();
	    				}
					
									   				
	    				if(row7.CD_TYPE_FA != null) {
    				
							xlsxTool_tFileOutputExcel_3.addCellValue(String.valueOf(row7.CD_TYPE_FA));
	    				} else {
	    					xlsxTool_tFileOutputExcel_3.addCellNullValue();
	    				}
					
									   				
	    				if(row7.SIO_LB_NATLOC != null) {
    				
							xlsxTool_tFileOutputExcel_3.addCellValue(String.valueOf(row7.SIO_LB_NATLOC));
	    				} else {
	    					xlsxTool_tFileOutputExcel_3.addCellNullValue();
	    				}
					
									   				
	    				if(row7.SID_LB_FAM_RUB != null) {
    				
							xlsxTool_tFileOutputExcel_3.addCellValue(String.valueOf(row7.SID_LB_FAM_RUB));
	    				} else {
	    					xlsxTool_tFileOutputExcel_3.addCellNullValue();
	    				}
					
									   				
	    				if(row7.NO_RUB_FA != null) {
    						
							xlsxTool_tFileOutputExcel_3.addCellValue((row7.NO_RUB_FA.setScale(0, java.math.RoundingMode.HALF_UP)).doubleValue());
	    				} else {
	    					xlsxTool_tFileOutputExcel_3.addCellNullValue();
	    				}
					
									   				
	    				if(row7.LB_RUBCOUR != null) {
    				
							xlsxTool_tFileOutputExcel_3.addCellValue(String.valueOf(row7.LB_RUBCOUR));
	    				} else {
	    					xlsxTool_tFileOutputExcel_3.addCellNullValue();
	    				}
					
									   				
	    				if(row7.TOU_FACT_TOT != null) {
    						
							xlsxTool_tFileOutputExcel_3.addCellValue((row7.TOU_FACT_TOT.setScale(4, java.math.RoundingMode.HALF_UP)).doubleValue());
	    				} else {
	    					xlsxTool_tFileOutputExcel_3.addCellNullValue();
	    				}
 ...
 */
    ...
    public static void main(String[] args){
        final Quittancement201902 Quittancement201902Class = new Quittancement201902();

        int exitCode = Quittancement201902Class.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Quittancement201902.class.getClassLoader().getResourceAsStream("happi/quittancement201902_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Quittancement201902.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Quittancement201902");
        }
...
/************************************************************************************************
 *     137559 characters generated by Talend Open Studio for Data Integration 
 *     on the 30 mars 2021 10:55:17 CEST
 ************************************************************************************************/